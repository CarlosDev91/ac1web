...
import { ApoliceDeSeguroComponent } from './apolicedeseguro/apolicedeseguro.component';
import { ConversordetemperaturaComponent } from './conversordetemperatura/conversordetemperatura.component';
...
export const routes: Routes = [
    ...
    { path: 'seguro', component: ApoliceDeSeguroComponent },
    { path: 'temperatura', component: ConversordetemperaturaComponent},
